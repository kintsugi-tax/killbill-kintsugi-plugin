...
Kill Bill feedback on [PR #1](https://github.com/killbill/killbill-kintsugi-plugin/pull/1) asks for enterprise parity with Aviate deployment patterns. Shipped in **0.1.0** on `kintsugi-tax`; upstream `killbill/killbill-kintsugi-plugin` syncs separately.
