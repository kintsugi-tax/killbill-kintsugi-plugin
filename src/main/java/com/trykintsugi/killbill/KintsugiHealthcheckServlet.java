...
@Singleton
@Path("/healthcheck")
public final class KintsugiHealthcheckServlet extends PluginHealthcheck {

    private final KintsugiHealthcheck healthcheck;

    @Inject
    public KintsugiHealthcheckServlet(final KintsugiHealthcheck healthcheck) {
