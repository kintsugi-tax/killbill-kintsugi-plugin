 ...
 *
 * <p>The Aviate plugin is expected to pass these on invoice generation; custom fields remain the
 * fallback for non-Aviate deployments.
 */
public final class InvoicePluginPropertyNames {

    /** Entity use code for the customer. */
    ...
    /** Per-line tax code prefix; full key is {@code taxCode_<invoiceItemId>}. */
